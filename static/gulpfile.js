...
const cssTasks = [{
  ...
  config: {
    src: [
      ...
      'assets/css/src/general/data-toggle.less',
      'assets/css/src/components/navigation.less',
      'assets/css/src/components/breadcrumbs.less',
      'assets/css/src/components/menu-content.less',
      'assets/css/src/components/api-info.less',
      'assets/css/src/components/code-block.less',
      'assets/css/src/components/samples-block.less',
      'assets/css/src/components/table.less',
      'assets/css/src/components/callout.less',
      'assets/css/src/components/footer.less',
      'assets/css/src/components/autocomplete.less',
      'assets/css/src/components/suggestion.less',
